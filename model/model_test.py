...
class PMiASeg(nn.Module):
    ...
    def forward(self, image):
        ...
        d_seq = self.diff_GCN(d_seq)    # (bs, frame_num-1, channel, img_shape[0], feature_dim, feature_dim)

        d_prime_seq = torch.reshape(d_seq, (batch_size, frame_num-1, self.feature_shape[0], -1)) # (bs, frame_num-1, channel, img_shape[0]*feature_dim*feature_dim)
        ...
        # f_prime_seq = torch.Tensor(f_seq)
