...
class DRGLBlock(nn.Module):
    def __init__(self, frame_num, feature_shape, channel_dim, hidden_dim, dropout, topk=10):
        ...
        self.SGL_layer1 = GLConv(in_channels=channel_dim, out_channels=channel_dim, bias=False, dropout=dropout)

        self.TGL_layer1 = GLConv(in_channels=channel_dim, out_channels=channel_dim, bias=False, dropout=dropout)
    ...
    def forward(self, d_seq):
        ...
        d_seq = self.SGL_layer1(d_seq, adj_dseq_hat)  # (bs, frame, feature_num, channel)
        ...
        d_seq = self.TGL_layer1(d_seq, adj_frame_hat)
